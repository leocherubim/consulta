...
<div class="container">
	...
	<form method="post" action="/consulta/registrado">
		...
		Prescrição Médica: <input type="text" name="prescricaoMedica">
		<br>

		<!-- Campo de cadastro de DATA PARA RETORNO -->
		Data de Retorno: <input type="text" name="dataRetorno">
		<br>

		<!-- Campo de cadastro de ENCAMINHAMENTO -->
		Encaminhamento: <input type="text" name="encaminhamento">
		<br>

		<!-- Campo de cadastro de HORA CONSULTA -->
		Horário da Consulta: <input type="text" name="horaConsulta">
		<br>

		<!-- Campo de cadastro de DATA CONSULTA -->
		Data da Consulta: <input type="text" name="dataConsulta">
		<br>
